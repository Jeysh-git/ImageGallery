# imagegal1.scss [![NPM version](https://badge.fury.io/js/imagegal1.scss.png)](http://badge.fury.io/js/imagegal1.scss) 
...
```bash
npm install imagegal1.scss --save-dev
```

Once that's done, add this line to your project's Gruntfile:

```js
grunt.loadNpmTasks('imagegal1.scss');
```
